...
for(i in 1:dim(fixture_info)[1]) {
  ...
  mutate(TEAM=if_else(TEAM=="KOSNER BASKONIA VITORIA-GASTEIZ","BASKONIA VITORIA-GASTEIZ",TEAM),
         TEAM=if_else(TEAM=="CRVENA ZVEZDA MERIDIANBET BELGRADE","CRVENA ZVEZDA MERIDIAN BELGRADE",TEAM))
